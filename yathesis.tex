...
%% \documentclass[lang=chs, degree=phd, blindreview=false, adobe=false]{ya-npu/yanputhesis}
%% 博士、盲评版本、不使用 Adobe 字体
%% \documentclass[lang=chs, degree=phd, blindreview=true, adobe=false]{ya-npu/yanputhesis}
%% 博士、正常版本、强制使用 Windows 系统字体
\documentclass[lang=chs, degree=phd, blindreview=false, winfonts=true]{ya-npu/yanputhesis}
%% 硕士、正常版本、不使用 Adobe 字体
%% \documentclass[lang=chs, degree=master, blindreview=false, adobe=false]{ya-npu/yanputhesis}
%% 硕士、盲评版本、不使用 Adobe 字体
%% \documentclass[lang=chs, degree=master, blindreview=true, adobe=false]{ya-npu/yanputhesis}
%%=============================================================================%
%% 导言区：请自行添加额外宏包
%%-----------------------------------------------------------------------------%
...
%-> Math packages
%-
\RequirePackage{amsmath,amssymb}% math structures, and extended symbols
...
%\addbibresource[location=local]{Biblio/ref}%biblatex宏包的参考文献数据源加载方式
%\printbibliography[heading=bibliography,title=参考文献] %打印参考文献表在合适的地方
...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.2]{ya-npu/poster.png}
    \caption{
        这里是个普通的标题
    }
    \label{fig:example}
...
\begin{figure}[htb]
    ...
    \begin{minipage}[t]{0.96\textwidth}
        ...
        \begin{subfigure}[t]{0.47\textwidth}
            \centering
            \includegraphics[scale=0.1]{ya-npu/poster.png}
...
\bibliographystyle{ya-npu/nputhesis-noslash}                       % 参考文献改进格式
\bibliography{Biblio/reference,Biblio/ref}                                  % 参考文献
\appendix
